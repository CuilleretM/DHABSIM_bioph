...
$ifi %CROP%==on   $ifi %BIOPH%==on +  sum((crop_activity_endo,field,inten),sum((crop_preceding) $ c_c(crop_activity_endo,crop_preceding),                 V_Plant_C(hhold,crop_activity_endo,crop_preceding,field,inten,y) *  enerReqtask_crop(hhold,crop_activity_endo,inten,"irrigation")*sum(m,p_irrigation_opt_fixed(hhold,crop_activity_endo,field,inten,m,'y01'))))

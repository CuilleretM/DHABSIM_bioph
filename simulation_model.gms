...
E_Tot_WaterUse ..
     V_Tot_WaterUse          =E=0 
$ifi %CROP%==on + SUM((hhold,crop_activity,field,inten,y),v_Prd_C(hhold,crop_activity,field,inten,y)/ (sum(m,v_irrigation_opt(hhold,crop_activity,field,inten,m,y)* sum(crop_preceding,V_Plant_C(hhold,crop_activity,crop_preceding,field,inten,y)))+0.0001));
...
*BLUEWATER CROP
$ifi %CROP%==on + sum((hhold,m,crop_activity,field,inten),min(v_irrigation_opt.l(hhold,crop_activity,field,inten,m,'y01'),max(0, (ET0_month(hhold,crop_activity,field,inten,m,'y01') * p_kc(crop_activity,field,inten)) - p_rain('y01',m)))*sum(crop_preceding,V_Plant_C.L(hhold,crop_activity,crop_preceding,field,inten,'y01')))
*BLUEWATER ORCHARD
$ifi %ORCHARD%==on + sum((hhold,m,c_tree,field,inten),min(v_irrigation_opt.l(hhold,c_tree,field,inten,m,'y01'),max(0, (ET0_month(hhold,c_tree,field,inten,m,'y01') * p_kc(c_tree,field,inten)) - p_rain('y01',m)))*sum(age_tree,V_Area_AF.L(hhold,field,c_tree,age_tree,inten,'y01')))
;

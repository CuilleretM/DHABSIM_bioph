...
p_Yld_C_max(hhold,crop_activity,'allp',field,inten) $ (p_cropCoef(hhold,crop_activity,field,inten,'yield')>0) = 
    ym(crop_activity,field,inten);
p_Yld_C_max(hhold,crop_activity,crop_preceding,field,inten) = p_Yld_C_max(hhold,crop_activity,'no_plant',field,inten);
...
$ifi %CROP%==ON  p_Npot(hhold,crop_activity,field,inten)$(K1(crop_activity)<> 0) = p_Yld_C_max(hhold,crop_activity,'allp',field,inten)*K1(crop_activity)
...
p_Yld_C_max(hhold,crop_activity_endo,crop_preceding,field,inten)=p_Yld_C_max(hhold,crop_activity_endo,'allp',field,inten);
display p_Npot;
****RESIDUE**** -> variabilize
